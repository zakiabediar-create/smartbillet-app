...
export default function App() {
  ...
  // Paramètres spécifiques œuvre par œuvre (État modifiable dans l'onglet Paramètres)
  ...
  // Si un spectacle est sélectionné, on utilise son objectif spécifique de rentabilité
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {activeTab === 'Paramètres' ? (
          ...
          <div className="bg-[#131927] border border-slate-800/80 rounded-xl p-6 space-y-6">
            ...
            {/* 2. NOUVEAU : Spécificités Économiques Œuvre par Œuvre */}
            <div className="space-y-3 bg-[#0E131F] p-4 rounded-lg border border-slate-800/80">
          ...
          <>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="bg-[#131927] border border-slate-800/80 p-4 rounded-xl space-y-2 relative">
                ...
                <p className="text-[9px] text-slate-500">Couverture des coûts fixes ({selectedSpectacleId === 'all' ? 'Global' : spectaclesList.find(s => s.id === Number(selectedSpectacleId)).title})</p>
              </div>
